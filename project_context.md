...
- På `Samtliga tippningar` går det att välja två tippningar för jämförelse. En jämförelsepanel visar likheter och skillnader för Sveriges matcher, gruppspel, Topp 3 och turneringsfrågor. När två tippningar valts scrollar appen till jämförelsen, fler val låses tills användaren klickar `Rensa val`, kolumnrubrikerna visar initialerna i varje sektion och mobilvyn visar initialerna direkt vid varje staplat svar. Grön bakgrund betyder exakt lika, gul betyder delvis lika och röd/varm bakgrund betyder olika. Gul status används för samma 1/X/2-tecken i Sveriges matcher och samma gruppspelslag men på omvända placeringar.
